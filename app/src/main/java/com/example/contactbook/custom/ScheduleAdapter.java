...
public class ScheduleAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtAttend = (TextView) convertView.findViewById(R.id.attendance);

        items.sort((o1, o2) -> {
            return o1.getScheduleTo().equals(o2.getScheduleTo()) ? 1 : 0;
        });
    ...
    class ViewHolder {
        TextView txtTime, txtSubject, txtTeacher, txtClass, txtAttend;
    }
}
